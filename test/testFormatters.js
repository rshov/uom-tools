...
describe('test formatFeetAndFractionalInches()', () => {
  ...
  it('should format as feet and fractional inches', () => {
    expect(formatFeetAndFractionalInches(38.5, 'in', 'in16')).to.equal('3\' 2-1/2"')
...
describe('test formatLength()', () => {
  ...
  it('should format in the given unit and show the unit symbol', () => {
    ...
    expect(formatLength(5.015625, 'in', 'in', 'in64', true)).to.equal('5-1/64"')
    expect(formatLength(5, 'ft', 'ft', undefined, true)).to.equal('5 ft')
    expect(formatLength(1.5, 'in', 'ft_in', undefined, true)).to.equal('1-1/2"')
    expect(formatLength(20.5, 'in', 'ft_in', undefined, true)).to.equal('1\' 8-1/2"')
  })
